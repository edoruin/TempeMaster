...
const char* mqtt_client_id = "ESP32-MAKERSPACE";
const char* mqtt_user = "testadmin";
const char* mqtt_password = "Test123456";

const char* topic_temp = "sensor/makerspace/temperatura";
const char* topic_hum = "sensor/makerspace/humedad";
...
void setup() {
  ...
  if (WiFi.status() != WL_CONNECTED) {
    ...
    lcd.setCursor(0, 1);
    lcd.print("ESP32-MAKER");
    wm.startConfigPortal("ESP32-MAKERSPACE");
  }
